...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Panel Petugas :: Tambah Foto</title>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li  class="active"><a href="add_new_photo.php"><i class="fa fa-angle-double-right"></i>Tambah Foto</a></li>
                ...
                <!-- Main content -->
                		<section class="content">
                    		 <div class="box box-primary">
                                <!-- form start -->
                                <form role="form" enctype="multipart/form-data" method="post" action="../../process/create_new_photo.php" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">Foto</label>
                                            <input type="file" id="foto" name="foto" required>
                                            <p class="help-block">Silakan Masukkan Foto <br>
                                            Ukuran Maksimal 1600x1200</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Keterangan</label>
                                            <textarea class="form-control ckeditor" rows="4" placeholder="Masukkan Keterangan" name="ket" id="ket" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Album</label>
