                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="data_hotel.php"><i class="fa fa-angle-double-right"></i> Laporan Hotel atau Tempat Penginapan</a></li>
                                    ...
                                    <table class="table table-striped">
                                        <tr>
                                         ...
                                         <?php
											...
											//$album = $_POST['Album'];
											//queri
											$queri = "SELECT * FROM `sig_hotel` where status = 'Approve' order by name asc LIMIT $offset, $dataPerPage ";
