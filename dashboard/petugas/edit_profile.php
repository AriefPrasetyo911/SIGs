...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Panel Petugas :: Edit Profil</title>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="data_admin.php"><i class="fa fa-angle-double-right"></i> Daftar Admin</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                     ...
                     <div class="box box-primary">
                                ...
                                ?>
                                <!-- form start -->
                                <form role="form" method="post" action="../../process/update_profil_petugas.php">
                                    <div class="box-body">
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control" value="<?php echo $urai['Username'];?>" disabled>
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="Names" class="form-control" id="Names"  value="<?php echo $urai['Nama_Lengkap'];?>">
                                        </div>
                                         <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control ckeditor" rows="4" name="Alamat" id="Alamat"><?php echo $urai['Alamat'];?></textarea>
                                        </div>
                                        <hr>
                                        <div class="form-group">
