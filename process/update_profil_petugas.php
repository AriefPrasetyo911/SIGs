...
$optionsRadios 	= anti_injection($_POST['optionsRadios']);
...
{
	$ubah = mysql_query("UPDATE `sig_auth_user` SET `Username`='$Username',`Password`='$enkrip_pass',`Nama_Lengkap`='$Names',`Jenis_Kelamin`='$optionsRadios',`Alamat`='$Alamat' WHERE Username='$Username'");
	...
	if($ubah)
	{
        ...
        <meta http-equiv="refresh" content="3; url=../dashboard/petugas/profile.php" />
        <?php
	}
	else
	{
...
else
{
    ...
    <meta http-equiv="refresh" content="3; url=../dashboard/admin/profile.php" />
    <?php
}
?>