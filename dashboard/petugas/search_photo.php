...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Panel Petugas :: Cari Data Foto</title>
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                       ...
                                       <tr>
                                           ...
                                           <td><a href="edit_photo.php?id_foto=<?php echo $urai['id_foto']?>" title="Edit"><button class="btn btn-info btn-sm">Edit</button></a> | <a href="../../process/delete_photo.php?id_foto=<?php echo $urai['id_foto'];?>" onClick="return confirm('Apakah Anda akan Menghapus Foto dengan id = <?php echo $urai['id_foto'];?> ?')" title="Hapus Foto"><button class="btn btn-danger btn-sm">Hapus</button></a></td>
                                            </tr>
                                         <?php }
											}
											else
