...
<head>
        <meta charset="UTF-8">
        <title>Panel Petugas :: Edit Foto</title>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="data_photo.php"><i class="fa fa-angle-double-right"></i>Lihat Foto</a></li>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Tambah Foto Baru</li>
                    </ol>
                </section>
                ...
                <section class="content">
                     ...
                     <div class="box box-primary">
								...
								//ambil data
								$queri = mysql_query("SELECT * FROM `sig_data_photo` WHERE id_foto ='$id_foto'");
								//pecah
								while($urai = mysql_fetch_array($queri))
								{
                                ?>
                                <!-- form start -->
                                <form role="form" enctype="multipart/form-data" method="post" action="../../process/update_photo.php" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" id="id_foto" name="id_foto" value="<?php echo $id_foto;?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputFile">Foto</label>
                                            <input type="file" id="exampleInputFile" name="foto" disabled>
                                            <p class="help-block">Foto saat ini : <?php echo $urai['foto'];?></p>
                                        </div>
                                         <div class="form-group">
                                            <label>Keterangan</label>
                                            <textarea class="form-control ckeditor" rows="4" placeholder="Masukkan Keterangan" id="ket" name="ket" required><?php echo $urai['keterangan'];?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Album</label>
